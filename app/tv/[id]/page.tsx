...
import { TVShowSkeleton } from '@/components/tv-show-skeleton';
import { getTVDetails, getTVSeason, getSimilarTVShows, getTVVideos, getTVReviews } from '@/lib/tmdb';
...
async function TVShowData({ tvId, season, episode }: { tvId: number; season: number; episode: number }) {
