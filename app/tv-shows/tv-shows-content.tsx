...
import { DiscoverParams, discoverTVShows, Genre, Media } from '@/lib/tmdb';
...
export function TVShowsContent({ initialGenres, initialTVShows }: TVShowsContentProps) {
            ...
            <div>
              ...
              {!isLoading && (
                <p className="text-muted-foreground mt-1 text-sm">
                  {totalResults.toLocaleString('en-US')} TV shows found
                </p>
              )}
            </div>
